...
🚀 Co-founder of [Prediction Live](https://prediction.live) – Real-time betting on esports live streams  
...
- 🧠 Currently building **Prediction Live**, a real-time betting platform for esports streams, and cybersecurity training programs for non-tech SMEs.
...
**Prediction Live** is a real-time betting platform where users can place bets on esports matches as they watch live streams. Built with modern web technologies and blockchain integration.
...
- **Authentication**: Privy (Web3 + OAuth)
- **Real-time**: Supabase Realtime subscriptions
- **Deployment**: Vercel
- **Blockchain**: Solana integration for wallet connections
...
### Backend & APIs
`Node.js` `Next.js API Routes` `Supabase` `PostgreSQL`  

### Blockchain & Web3
`Solidity` `Hardhat` `Foundry` `Ethers.js` `Solana` `Privy`  
...
| Hacking Paris Chiliz                              | Jul 2025     | 🥇 1st place – **Prediction Live**, real-time betting on esports live streams                             |

---

## 📫 Let's Connect

[Email](githubtyler@gmail.com)  
